...
var buildLanguagesPath = path.join(nconf.get('base_dir'), 'build/public/language');
//var coreLanguagesPath = path.join(__dirname, '../../slax/src/languages');
var coreLanguagesPath = path.join(nconf.get('base_dir'), 'slax/src/languages');
