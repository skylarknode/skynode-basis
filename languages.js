...
var languagesPath = path.join(nconf.get('base_dir'), 'build/public/language');

//const files = fs.readdirSync(path.join(__dirname, '../public/vendor/jquery/timeago/locales')); // modified by lwf
