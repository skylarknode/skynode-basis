	...
	function onSettingsLoaded(uid, settings, callback) {
		async.waterfall([
			...
			function (data, next) {
				...
				var defaultTopicsViewMode = meta.config.topicsViewMode; // added by lwf
				...
				settings.topicsViewMode = getSetting(settings, 'topicsViewMode', defaultTopicsViewMode); // added by lwf
