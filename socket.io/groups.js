...
var SocketGroups = ns.groups = module.exports;
...
SocketGroups.search = function (socket, data, callback) {
	...
	if (!data.query) {
		...
		privileges.groups.getGroupsFromSet.getGroupsFromSet(socket.uid, data.options.sort, 0, groupsPerPage - 1, function (err, data) {
...
SocketGroups.loadMore = function (socket, data, callback) {
	...
	privileges.groups.getGroupsFromSet.getGroupsFromSet(socket.uid, data.sort, start, stop, callback);
};
